...
public class TuoteController {
	...
	/* vaihdettu pois, koska kun poistaa tuoteluokan, myös kyseisessä tuoteluokassa olevat tuotteet poistetaan
	...
	//v1.3. päivitetty, estetty tuoteluokan poistaminen jos siinä on tuotteita
