...
, ("Kodinkoneet"), ("Huonekalut"), ("Sisustus");
...
VALUES ("Pentti", "Peruskäyttäjä","user","$2a$10$RIqlxElPXzQKJayHKJwSNOxDMnMh.j.OHwQvOoPj0gld.sbXsqqgK" ,"USER"), 
("Nadja", "Liljeström", "admin", "$2a$10$aGjp6jEUEspwUkQrCbGAWuKScc9DRHTQ6LXMRX2TAM5A6tzHdy8/6", "ADMIN"),
("Iiro", "It-tuki", "huolto", "$2a$10$lDtQP3VTBBHPocsCga.a6.iqXrQq2S3.nlaWJieniRwYlOUjpttUS", "ADMIN");
