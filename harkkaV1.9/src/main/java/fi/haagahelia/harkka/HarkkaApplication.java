 ...
 * 
 * Muista application.properties ja HarkkaApplication.java jos siirryt takaisin h2-kantaan
 * 
 * Testattu että tietokanta toimii: 
 * 
 * lisää/poista tuote
 * lisää/poista tuoteluokka (tuoteryhmä) jos sallittu
 * lisää/poista käyttäjä
 * 
 * muokkaa tuote/tuoteluokka(tuoteryhmä)
 * 
 * 
 * 
 * ************************************************************************************************
